...
images,images_test = np.asarray(Imagelist_train)/255.0,np.asarray(Imagelist_test)/255.0
del Imagelist_train
del Imagelist_test	
#print (labels_vec[0], labels_valid_vec[0],images[0], images_test[0])
#exit()
...
train_list = []
test_list = []
saver.restore(sess,'./save/model_197.ckpt')
...
#        for j in range(500):
#            
#            batch_xs = images_test[j*100:j*100+100]
...
#        test_list.append(test_acc/500.0)
#        train_list.append(train_acc/500.0)
#        print("Training accuracy   @  ",i,"  :  ",train_list[int(i/500)])
#        #test_list.append(accuracy.eval({x:images_test, y_:test_label, keep_prob:1.0}))
...
#        save_path = saver.save(sess, '/home/development/lakshya/mtp_matter/DataMiningProject/Imagetagging/cifar-10/save/model_'+str(int(i/500))+'.ckpt')
#
#
#
train_acc = 0
